        ...
        <CardContent className="p-8 relative">
          ...
          <div className="flex flex-col items-center gap-4 mt-8">
            <p className="text-lg md:text-xl font-body italic text-foreground/90">
              There are parts of me that only exist because of you.
              I couldn’t ask for more. Just remember, no one loves you like I do.
              Today, tomorrow, and in all the moments we haven’t lived yet. Before you, I was a story half-told. With you, I am home.
              I am not one without you ❤️
            </p>
          </div>
